...
public class NamedParameterStatement {
	...
	private int[] getIndexes_multi(String name1, String name2) {
		int[] indexes1 = (int[]) indexMap.get(name1);
		int[] indexes2 = (int[]) indexMap.get(name2);
		if (indexes1 == null && indexes2 == null) {
			throw new IllegalArgumentException("Parameter not found: " + name2);
	...
	public void setStringWithMultipleValue(String name1, String value1,
			String name2, String value2) throws SQLException {
		int[] indexes = getIndexes(name1);
		for (int i = 0; i < indexes.length; i++) {
			statement.setString(indexes[i], value1);
